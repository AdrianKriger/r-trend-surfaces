...
This Notebook (the second-of-four) serves to introduce a user to a series of exercises focused on higher order Trend Surface analysis with R.
...
We create a grid slightly different from the previous [trendSurface01 notebook](https://github.com/AdrianKriger/r-trend-surfaces/blob/main/trendSurface01.rmd) method 
