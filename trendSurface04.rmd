...
```
<div class="alert alert-info">
  <strong>This is a good time to create a _fancy interactive_ 3D surface plot</strong> </div>
...
fig <- plot_ly( z = example_matrix, colors = rainbow(100)); fig <- fig.update_layout(scene_camera=camera_params) %>% add_surface();
fig
