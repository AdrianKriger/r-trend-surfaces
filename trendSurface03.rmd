...
```{r read-dataset }
#-- read
file = 'cptFlatsAquifer_watertable.txt'
```
...
- **Question 4.** Does there appear to be any local spatial correlation of the residuals?
...
- **Question 5.** How well does the GAM trend surface fit the points? Are there obvious problems?
...
- **Question 6.** Where are the largest differences between the GAM and 2nd order OLS trend surface predictions? Explain why, considering how the two surfaces are computed.
...
- **Question 7.** What are the estimated sill, range, and nugget of this variogram?
